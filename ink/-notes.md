...
This is an example found usually at the end of a character's dialogue, offering the player a choice. Adding "_# CLASS: player-answer_" will stylize the text after the player makes the choice.
...
**Photo or Image** # IMAGE: ./images/ship-console.png
